...
df_train = pd.read_json('./data/4-train-sbert.json', lines=True)

df_test = pd.read_json('./data/4-test-sbert.json', lines=True)

df_dev = pd.read_json('./data/4-train-sbert.json', lines=True)
...
output_model_file = "./model/Qblink_50_bert_regressor1.pth"
...
# Save a trained model
model_to_save = model.module if hasattr(model, 'module') else model  # Only save the model it-self
output_model_file = "./model/Qblink_50_bert_regressor2.pth"
torch.save(model_to_save.state_dict(), output_model_file)
...
# Save a trained model
model_to_save = model.module if hasattr(model, 'module') else model  # Only save the model it-self
output_model_file = "./model/Qblink_50_bert_regressor3.pth"
torch.save(model_to_save.state_dict(), output_model_file)
...
model.load_state_dict(torch.load("./model/Qblink_50_bert_regressor3.pth"))
