...
train_path = './data/4-train.json' 
test_path = './data/4-test.json' 

train_path_w = './data/4-train-sbert.json'  
test_path_w = './data/4-test-sbert.json' 
  ...
  for line in s_f:
    ...
    try:
      if can_go:
        ...
        jsonobj = {"index":index2,"question":question,"triple":{"q_et":q_et,"sentence":sentence , "c_et":c_et, "ans":answer, "score":score}}
